...
{
    public class GetDeleteFolderActivityLogByIdRepository : IGetDeleteFolderActivityLogByIdRepository
    {


        public Response GetDeleteFolderActivityLogBtId(string CustId, Int64 UserId)
        {
            ...
            try
            {
                ...
                dset = Obj_getsetdb.GetDeleteFolderActivityLogBtId(CustId, UserId);
                string JSONresult;
